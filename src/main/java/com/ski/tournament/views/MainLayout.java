...
import com.ski.tournament.views.helloworld.HelloWorldView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Ski Tournament logo"));
        logoLayout.add(new H1("Ski Tournament"));
    ...
    private List<Tab> createMenuItems() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Tournaments", "la la-file", TournamentsView.class), //

                new MenuItemInfo("Places", "la la-th-list", PlacesView.class), //
