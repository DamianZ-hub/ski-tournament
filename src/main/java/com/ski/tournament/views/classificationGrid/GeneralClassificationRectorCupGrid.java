...
public class GeneralClassificationRectorCupGrid extends VerticalLayout implements AfterNavigationObserver {
    ...
    public GeneralClassificationRectorCupGrid(ClassificationService classificationService,
        ...
        tournamentList.forEach(tournament -> {
            ...
            }).setHeader(tournament.getCompetition().label2 + " " + tournament.getUnit().getShortName()).setAutoWidth(true);
        });
        EnhancedColumn<ClassificationDataView> classificationDataViewEnhancedColumn = (EnhancedColumn<ClassificationDataView>) grid.addColumn(classificationDataView -> {
            return classificationService.calculateSumForRectorCupClassification(classificationDataView.getScoreMap());
