...
@Entity
public class SingleCompetitionsOneCompetitionTypeData extends AbstractEntity {
    ...
    public SingleCompetitionsOneCompetitionTypeData(@NotNull PersonTournamentData personTournamentData, int takenPlace, double firstRideTime, double secondRideTime, double sumariseRideTime, Integer score) {
        this.personTournamentData = personTournamentData;
        this.takenPlace = takenPlace;
        this.firstRideTime = firstRideTime;
        this.secondRideTime = secondRideTime;
    ...
    public SingleCompetitionsOneCompetitionTypeData() {
    }
}
